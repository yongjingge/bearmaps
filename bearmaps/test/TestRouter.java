...
public class TestRouter {
    private static final String PARAMS_FILE = "/Users/geyongjing/Desktop/bearmap/library-sp19-master/data/proj2c_test_inputs/path_params.txt";
    private static final String RESULTS_FILE = "/Users/geyongjing/Desktop/bearmap/library-sp19-master/data/proj2c_test_inputs/path_results.txt";
    private static final int NUM_TESTS = 8;
    private static final String OSM_DB_PATH = "/Users/geyongjing/Desktop/bearmap/library-sp19-master/data/proj2c_xml/berkeley-2019.osm.xml";
    ...
    public void testShortestPath() throws Exception {
        ...
        for (int i = 0; i < NUM_TESTS; i++) {
            ...
            assertEquals("This is test" + i + ". Your results did not match the expected results", expected, actual);
            System.out.println("Test " + i + " has passed.");
        }
    }
